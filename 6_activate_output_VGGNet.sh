...
# Net
net_weights="nets/vgg19/VGG_ILSVRC_19_layers.caffemodel"
net_definition="nets/vgg19/VGG_ILSVRC_19_layers_deploy.prototxt"
...
# Make a collage
output_file=${output_dir}/example.jpg
montage ${list_files} -tile 1x1 -geometry +1+1 ${output_file}
